...
import { ScreenshothisDefaultError } from "../models/errors/screenshothisdefaulterror.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | ScreenshothisDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<
        T,
        E | ScreenshothisDefaultError | ResponseValidationError
      >,
      raw: unknown,
    ]
  > {
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new ScreenshothisDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new ScreenshothisDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
